...
**60+ स्किल्स · 11 कमांड्स · 1 प्लगइन · 7+ प्लेटफॉर्म्स · 6 भाषाएं**
...
CodyMaster सिर्फ "एक और AI स्किल्स पैक" नहीं है। यह **10+ साल का प्रोडक्ट मैनेजमेंट अनुभव + 6 महीने की बैटल-टेस्टेड वाइब कोडिंग** है, जिसे 60+ आपस में जुड़ी स्किल्स में पिरोया गया है जो एक **एकल एकीकृत प्रणाली** के रूप में काम करती हैं।
...
|---|---|---|
| **इंटीग्रेशन** | प्रत्येक स्किल स्टैंडअलोन है, कोई साझा संदर्भ नहीं है | 60+ स्किल्स जो चेन बनाते हैं, मेमोरी साझा करते हैं और संवाद करते हैं |
...
एक कमांड आपके वातावरण में सभी 60+ कौशल स्थापित करता है। यह Claude Code, Gemini CLI, Cursor, Aider, Windsurf, Cline, OpenCode आदि का समर्थन करता है:
...
> *"60+ कौशल। प्रत्येक कौशल एक सबक है। प्रत्येक सबक एक बिना नींद वाली रात है। और अब, आपको उन रातों से नहीं गुजरना पड़ेगा।"*
...
- 🛠️ [स्किल्स संदर्भ](skills/) — सभी 60+ SKILL.md फाइलें ब्राउज़ करें
