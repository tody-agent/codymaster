...
**60+ навыков · 11 команд · 1 плагин · 7+ платформ · 6 языков**
...
CodyMaster — это не просто "очередной набор навыков для AI". Это **10+ лет опыта управления продуктами + 6 месяцев проверенного в боях vibe coding**, воплощенные в 60+ взаимосвязанных навыках, которые работают как **единая интегрированная система**.
...
|---|---|---|
| **Интеграция** | Каждый навык автономен, нет общего контекста | 60+ навыков, которые объединяются в цепочки, разделяют память и взаимодействуют |
...
Одна команда устанавливает все 60+ навыков в вашу среду. Поддерживает Claude Code, Gemini CLI, Cursor, Aider, Windsurf, Cline, OpenCode и многие другие платформы:
...
> *"60+ навыков. Каждый навык — это урок. Каждый урок — бессонная ночь. И теперь вам не придется проходить через эти ночи."*
...
- 🛠️ [Справочник навыков](skills/) — Просмотреть все 60+ файлов SKILL.md
