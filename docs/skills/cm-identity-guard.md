...
description: "Verify and lock project identity before ANY git push, Cloudflare deploy, or Supabase operation. Essential when working with multiple GitHub accounts (personal +"
keywords: ["cm-identity-guard", "cody master", "ai skill"]
robots: "index, follow"
---
