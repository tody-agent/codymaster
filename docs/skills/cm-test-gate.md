---
title: "cm-test-gate"
description: "Complete guide to setting up a reliable test gate for any project — covers stack detection, 4 core test files, script wiring, secret hygiene, and Cloudflare Wor"
keywords: ["cm-test-gate", "cody master", "ai skill"]
robots: "index, follow"
---
