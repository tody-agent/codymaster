...
description: "Use when setting up deployment infrastructure for any project - establishes multi-gate deploy pipeline with test gates, build verification, frontend safety chec"
keywords: ["cm-safe-deploy", "cody master", "ai skill"]
robots: "index, follow"
---
