...
description: "Use when starting feature work that needs isolation from current workspace or before executing implementation plans - creates isolated git worktrees with smart "
keywords: ["cm-git-worktrees", "cody master", "ai skill"]
robots: "index, follow"
---
