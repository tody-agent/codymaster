---
title: "cm-continuity"
description: "Working memory protocol with 4-Tier Memory System — maintains context across sessions via CONTINUITY.md, learnings.json, decisions.json, and optional qmd semantic search."
keywords: ["cm-continuity", "cody master", "ai skill", "working memory", "context persistence"]
robots: "index, follow"
---
...
| `cm-deep-search` | Tier 4 — extends memory with semantic search for large codebases |
