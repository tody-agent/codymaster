...
description: "Use when starting any new project from scratch. Asks for project identity (name, GitHub org, Cloudflare account), detects project type, sets up design system, s"
keywords: ["cm-project-bootstrap", "cody master", "ai skill"]
robots: "index, follow"
---
