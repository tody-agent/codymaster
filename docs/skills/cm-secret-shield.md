...
description: "Defense-in-depth security for AI-assisted development. Pre-commit secret scanning, repo-wide pattern detection, token lifecycle management."
keywords: ["cm-secret-shield", "cody master", "ai skill"]
robots: "index, follow"
---
