...
| **Durable memory**     | `.cm/` + SQLite FTS or OpenViking backend (`src/storage-backend.ts`)                |
...
| **56 bundled skills**  | Opinionated workflows in `skills/*/SKILL.md` ([index](../skills/index.md))          |
