...
description: "[Deprecated] discovery and meta-skill merged. Use `cm-skill-index` instead."
deprecated: true
merged_into: cm-skill-index
---

# cm-skill-mastery — Deprecated

> ⚠️ This skill is deprecated as of CodyMaster v6.0.0 and will be removed in v6.1.0.
>
> **Use `cm-skill-index` instead.** discovery and meta-skill merged.
>
...
# New (v6.0+):   cm skill-index <equivalent action>
```
