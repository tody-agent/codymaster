...
| `tailwind-v4-shadcn` | jezweb/Codex-skills | tailwind v4, shadcn/ui |
| `tailwindcss-advanced-layouts` | josiahsiegel/Codex-plugin-marketplace | tailwind layouts, responsive |
...
| `supabase-edge-functions` | nice-wolf-studio/Codex-supabase-skills | edge functions, Deno |
| `nextjs-seo` | laguagu/Codex-nextjs-skills | SEO, meta tags, sitemap |
