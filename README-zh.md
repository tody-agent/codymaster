...
CodyMaster 不仅仅是“另一个 AI 技能包”。它是 **10 多年的产品管理经验 + 6 个月经过实战测试的 vibe coding** 的结晶，浓缩成了 33 项互连技能，作为一个**单一的集成系统**运行。
...
- 🌍 [网站](https://cody-master.pages.dev) — 概览与演示
- 📖 [文档](https://cody-master.pages.dev/docs) — 完整深度探索
- 🛠️ [技能参考](skills/) — 浏览所有34个SKILL.md文件
- 📖 [我们的故事](https://cody-master.pages.dev/story) — 为什么存在这个项目
