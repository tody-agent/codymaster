...
exports.cursor = {
    ...
    emoji: '⬡',
    detect() {
        if (fs.existsSync(path.join((0, paths_1.homeDir)(), '.cursor'))) {
    ...
    install(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const target = opts.scope === 'project'
                ...
                : path.join((0, paths_1.homeDir)(), '.cursor/rules');
            const { installed, skipped } = (0, copy_1.copySkills)(target, 'mdc', opts);
            return {
                platform: this.id,
                installed,
                skipped,
