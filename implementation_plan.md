...
| Config mẫu                                              | Tham chiếu trong skills (`cm-guardian-runtime`, …); file `.cm/config.example.yaml` nên được thêm vào repo khi hoàn tất P0/P1 (hiện có thể chưa có trong tree)                                  |
